...
\begin{document}
\subject
\asgntitle{2}{}{Week 2}{6733172621 Patthadon Phengpinij}{Claude (for\,\LaTeX\,styling and grammar checking)}
...
print("P(|0>):", prob_0)
\end{codingbox}
	which prints \( \begin{pmatrix} 0.4472 \\ 0.8944 \end{pmatrix} \) and \( P(\ket{0}) = 0.2 \), matching the hand-calculated result.
\end{solution}
% ================================================================================ %
